  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-7 order-lg-first">
        ...
        <p>Proudly designed in Norway by experts in engineering.</p>
...
<section id="proof" class="carousel">
  ...
  <div class="container text-lw p-4">
    ...
    <div class="row border-bottom">
      <div class="col-sm-4 mb-3">
        ...
        <p><a class="btn add-to-cart" href="/cart/?add-to-cart=<?= $handy_geo['id'] ?>">Buy Now &#8211;
            <?= $handy_geo['price'] ?>
          </a></p>
      </div>
    ...
    <div class="row mt-4">
      ...
      <div class="col-sm-6">
        ...
        <p>We've built a still-growing library together with several amazing content providers to deliver Handy
          ...
          and some cool deals if you are hungry for more.<a href="https://handyfeeling.com/partners"
            class="d-block text-lb">handyfeeling.com/partners</a>
        </p>
        ...
        <p>
          ...
          sites? No worries, you can synchronize your videos with the Handy locally. <a
            href="https://handyfeeling.com/local-video" class="d-block text-lb">handyfeeling.com/local-video</a>
        </p>
        ...
        <p>A long-distance relationship is not a problem now. This remote app gives you or a partner full motion control
          over the Handy. Put your Handy into your luggage and play whenever and with whoever you like. <a
            href="https://handyfeeling.com/remote" class="d-block text-lb">handyfeeling.com/remote</a>
        </p>
        ...
        <p>And the cherry on top - We sincerely think that we have the best active community that, together with us,
          ...
          just stay in touch you will get your mind blown! Play along and enjoy! <a
            href="https://www.handyfeeling.com/community" class="d-block text-lb">handyfeeling.com/community</a></p>
        <div class="row align-items-center">
          <div class="col-sm-6">
            <a class="btn visit btn-lg px-sm-4" href="https://handyfeeling.com">
              <img alt=""
                src="<?php echo get_template_directory_uri(); ?>/inc/assets/img/front/C6CC7BC6-81C2-44C7-93ED-88FA2765ADE9@3x.png"
                class="mr-2" width="12">Visit The Handy Feeling
            </a>
          </div>
          <div class="col-sm-6">
            <a class="btn btn-lg add-to-cart" href="/cart/?add-to-cart=<?= $handy_geo['id'] ?>">Buy Now -
              <?= $handy_geo['price'] ?>
            </a>
          </div>
        </div>
