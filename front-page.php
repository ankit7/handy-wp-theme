  ...
  <div class="container-fluid p-0">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 order-lg-first mt-4 mt-sm-0 first-col">
        <h2 class="display-4 fw-600">Say hello to The Handy™</h2>
        <p>The interactive automatic stroker. Proudly designed in Norway using state-of-the-art technology to bring you the most technically advanced machine of its kind on the market. Choose your own pleasure path: play with partners, sync with videos, connect with VR and more.</p>
        <p class="h5 fw-600 text-blg"><span class="product-price">$169</span> + <span class="product-shipping">Free Shipping</span></p> 
        <a class="btn add-to-cart product-link btn-lg" href="https://www.thehandy.com/cart/?add-to-cart=83780">Treat yourself</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container text-lw p-4">
    ...
    <div class="row">
      <div class="col-sm-4 mb-3">
        ...
        <h4 class="text-lw mb-0">Customise your grip</h4>
        ...
        <p class="pr-4"><a class="btn add-to-cart product-link btn-block" href="https://www.thehandy.com/cart/?add-to-cart=83780">Buy Now &#8211; <span class="product-price">$169</span></a></p>
      </div>
    ...
    <div class="row mt-4">
      ...
      <div class="col-sm-6">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-sm-6">
            <a class="btn btn-lg add-to-cart product-link btn-block" href="https://www.thehandy.com/cart/?add-to-cart=83780">Buy Now - <span class="product-price">$169</span></a>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  const updater = (
    ...
    links.forEach((el) => {
      el.href = `https://www.thehandy.com/cart/?add-to-cart=${newId}`;
    });
  };
  ...
  fetch(`https://api.ipstack.com/check?access_key=${access_key}`)
    ...
    .then((data) => {
      ...
      if (country === 'US') {
        ...
        updater('€199', '80985');
        // Adding warning for UK CORONA Ban
        document
          .getElementById('header-space')
          .insertAdjacentHTML(
            'afterend',
            '<div class="alert alert-info border-0 mb-0 rounded-0 px-0" role="alert"><div class="container"><div class="row"><div class="col-12"><div class="d-flex align-items-center justify-content-between"><span class="mr-3 mx-auto">We are now shipping to the UK with prepaid VAT through TNT. Please expect a bit longer shipping time due to customs process.</span></div></div></div></div></div>'
          );
      } else if (country === 'CA') {
